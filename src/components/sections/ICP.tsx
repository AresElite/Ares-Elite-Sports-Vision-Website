      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <ScrollReveal direction="up" distance={40} speed={1.1} className="h-full">
            <motion.div variants={variants.cardReveal} className="h-full flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm sm:text-base text-white/50 leading-relaxed font-light mb-6">
                  For those where 0.1s is the difference between winning and losing. We provide the infrastructure to close that gap.
                </p>
              </div>
              <div className="mt-auto pt-6 border-t border-white/5 flex flex-wrap items-center gap-4">
                <Link to="/pro-sports" className="text-xs font-bold text-[var(--color-ares-teal)] hover:text-white uppercase tracking-wider transition-colors inline-flex items-center">
                  Pro & Motorsports &rarr;
                </Link>
                <span className="text-white/20">|</span>
                <Link to="/athletes" className="text-xs font-bold text-white/60 hover:text-white uppercase tracking-wider transition-colors inline-flex items-center">
                  Athletes &rarr;
                </Link>
              </div>
            </motion.div>
          ...
          <ScrollReveal direction="up" distance={40} speed={1.3} className="h-full">
            <motion.div variants={variants.cardReveal} className="h-full flex flex-col justify-between">
              ...
              <div className="mt-auto pt-6 border-t border-white/5 flex flex-wrap items-center gap-4">
                <Link to="/parents" className="text-xs font-bold text-[var(--color-ares-teal)] hover:text-white uppercase tracking-wider transition-colors inline-flex items-center">
                  Parents & Youth &rarr;
                </Link>
                <span className="text-white/20">|</span>
                <Link to="/coaches" className="text-xs font-bold text-white/60 hover:text-white uppercase tracking-wider transition-colors inline-flex items-center">
                  Coaches &rarr;
                </Link>
              </div>
            </motion.div>
          ...
          <ScrollReveal direction="up" distance={40} speed={1.5} className="h-full">
            <motion.div variants={variants.cardReveal} className="h-full flex flex-col justify-between">
              ...
              <div className="mt-auto pt-6 border-t border-white/5 flex flex-wrap items-center gap-4">
                <Link to="/certification" className="text-xs font-bold text-[var(--color-ares-teal)] hover:text-white uppercase tracking-wider transition-colors inline-flex items-center">
                  Certification &rarr;
                </Link>
                <span className="text-white/20">|</span>
                <Link to="/technology-and-data" className="text-xs font-bold text-white/60 hover:text-white uppercase tracking-wider transition-colors inline-flex items-center">
                  Technology &rarr;
                </Link>
              </div>
            </motion.div>
